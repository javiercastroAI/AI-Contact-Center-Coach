...
**Security.** A signed CycloneDX SBOM (`sbom-cyclonedx.json`, SHA-256, dated 13 Dec 2025) is included. See [`.github/SECURITY.md`](.github/SECURITY.md) for the responsible-disclosure policy (response target ≤ 30 days) and embedded public PGP key.
